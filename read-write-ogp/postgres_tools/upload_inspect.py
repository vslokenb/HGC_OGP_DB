...
def get_query(table_name):
    if table_name == 'bp_inspect':
        ...
        (bp_name, flatness, thickness, x_points, y_points, z_points, date_inspect, time_inspect, hexplot, inspector, comment)
        VALUES """
    elif table_name == 'hxb_inspect':
        pre_query = f""" 
        INSERT INTO {table_name} 
        (hxb_name, flatness, thickness, x_points, y_points, z_points, date_inspect, time_inspect, hexplot, inspector, comment)
        VALUES  """
    elif table_name == 'proto_inspect':
        pre_query = f""" 
        INSERT INTO {table_name} 
        (proto_name, flatness, thickness, x_points, y_points, z_points, x_offset, y_offset, ang_offset, date_inspect, time_inspect, hexplot, inspector, comment)
        VALUES  """
    elif table_name == 'module_inspect':
        pre_query = f""" 
        INSERT INTO {table_name} 
        (module_name, flatness, thickness, x_points, y_points, z_points, x_offset, y_offset, ang_offset, date_inspect, time_inspect, hexplot, inspector, comment)
        VALUES  """
